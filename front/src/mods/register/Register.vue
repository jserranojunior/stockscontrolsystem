          ...
          <div class="card w-96 shadow-xl mt-12">
            <div class="card-body bg-base-300">
              ...
              <form class="form-control">
                <label class="block">
                  <input id="name" v-model="register.fields.name" type="text"
                    class="input input-sm w-full max-w-xs input-bordered" placeholder="Nome" />
                </label>
                <label class="block mt-2">
                  <div class="flex">
                    ...
                    <div class="w-full max-w-xs pl-2">
                      <input id="cellphone" v-model="register.fields.cellphone" type="text"
                        class="input input-sm w-full max-w-xs input-bordered" placeholder="Celular"
                        v-maska="'(##) #####-####'" />
                    </div>
                  </div>
                </label>
                ...
                <label class="block mt-2">
                  <input id="email" v-model="register.fields.email" type="email"
                    class="input input-sm w-full max-w-xs input-bordered" placeholder="Email" />
                </label>
                <label class="block mt-2">
                  <input id="password" v-model="register.fields.password" type="password"
                ...
                <label class="block mt-2">
                  <input id="confirmpassword" v-model="register.confirmPassword" type="password"
                    class="input input-sm w-full max-w-xs input-bordered" placeholder="Confirmar Senha"
                    autocomplete="on" />
                </label>
              </form>
              ...
              <div class="flex justify-between items-center mt-4">
                <div class="w-1/2"></div>
                <div class="w-1/2">
                  <button class="w-full py-2 px-4 rounded-md btn btn-sm" @click="cadastrar()">
                    Cadastrar
                  </button>
                </div>
              </div>
